...
static const std::array<std::vector<OpcodePattern>, opcode_count> OpcodeTable =
    [] {
      ...
      /// ============================================================================
      table[static_cast<size_t>(Opcode::ENTER)] = {
          EnterPatterns::imm16_imm8(),  // 0xC8  iw  ib
      };

      /// ============================================================================
      /// LEAVE — Destroy Stack Frame
      /// ============================================================================
      table[static_cast<size_t>(Opcode::LEAVE)] = {
          LeavePatterns::leave(),  // 0xC9
      };

      /// ============================================================================
      /// NOP — No Operation
      /// ============================================================================
      table[static_cast<size_t>(Opcode::NOP)] = {
          NopPatterns::nop(),  // 0x90
      };
